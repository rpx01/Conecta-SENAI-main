...
def upgrade() -> None:
    ...
    with op.batch_alter_table("lancamentos_rateio", schema=None) as batch_op:
        batch_op.create_index(
            "ix_lancamento_instrutor_periodo",
            ["instrutor_id", "ano", "mes"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_lancamentos_rateio_instrutor_id"),
            ["instrutor_id"],
            unique=False,
        )
    ...
    with op.batch_alter_table("ocupacoes", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_ocupacoes_grupo_ocupacao_id"),
            ["grupo_ocupacao_id"],
            unique=False,
        )
